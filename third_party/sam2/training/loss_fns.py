...
from SAM2.third_party.sam2.training.trainer import CORE_LOSS_KEY

from SAM2.third_party.sam2.training.utils.distributed import get_world_size, is_dist_avail_and_initialized
