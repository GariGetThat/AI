...
from SAM2.third_party.sam2.demo.backend.server.app_conf import (
    GALLERY_PATH,
    GALLERY_PREFIX,
    POSTERS_PATH,
    POSTERS_PREFIX,
...
from SAM2.third_party.sam2.demo.backend.server.data.loader import preload_data
from SAM2.third_party.sam2.demo.backend.server.data.schema import schema
from SAM2.third_party.sam2.demo.backend.server.data.store import set_videos
from flask import Flask, make_response, Request, request, Response, send_from_directory
from flask_cors import CORS
from SAM2.third_party.sam2.demo.backend.server.inference.data_types import PropagateDataResponse, PropagateInVideoRequest
from SAM2.third_party.sam2.demo.backend.server.inference.multipart import MultipartResponseBuilder
from SAM2.third_party.sam2.demo.backend.server.inference.predictor import InferenceAPI
