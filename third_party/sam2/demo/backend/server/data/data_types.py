...
import strawberry
from SAM2.third_party.sam2.demo.backend.server.app_conf import API_URL
from SAM2.third_party.sam2.demo.backend.server.data.resolver import resolve_videos
